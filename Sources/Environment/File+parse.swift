...
extension File {
     ...
     */
    public func parse(markEndLinePrefix: String? = nil) -> [String] {
     ...
     */
    public func parse(markSwitchToSecondBlockLinePrefix: String?, markEndLinePrefix: String? = nil) -> (firstBlock: [String], secondBlock: [String]) {
        let content: String
        do {
            content = try read()
        } catch {
